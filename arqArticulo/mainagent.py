...
def ejecutar_programa():
    ...
    while True:
        ...
        respuesta_contextualizado = agente_3(mensaje_estudiante,lista_requerimientos, respuesta_base, chat)

        # Mostrar la respuesta
        print("Respuesta del Agente:")
        print(respuesta_contextualizado)

        # Simulación de espera o ingreso de nuevos datos
        mensaje_estudiante = input("Ingrese el nuevo mensaje del estudiante o presione Enter para continuar con el anterior: ")
        if not mensaje_estudiante:  # Si el usuario no ingresa un mensaje, se usa el anterior
            mensaje_estudiante = mensaje_estudiante

        time.sleep(10)  # Espera 10 segundos antes de la próxima iteración
